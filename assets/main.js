...
function initializeAnimation() {
  ...
  $("#equation").html(
    "____CO<sub>2</sub>&nbsp;&nbsp;&nbsp;+&nbsp;&nbsp;____H<sub>2</sub>O&nbsp;&nbsp;=&nbsp;&nbsp;???"
  );
...
function setCanvasDimensions() {
  ...
  let containerWidth = container.clientWidth > 1248 ? 1024 : container.clientWidth - 224;
...
function movePhoton1(hasH20) {
  ...
  photon1.animate(
    { left: 263, top: 452 },
    {
      ...
      onChange: canvasModel.renderAll.bind(canvasModel),
      onComplete: function () {
        chlorophyll1.animate(
          { left: 272, top: 445, angle: 42 },
          {
            duration: 100 * time,
            onChange: canvasModel.renderAll.bind(canvasModel),
            onComplete: function () {
              if (!hasH20) {
                ...
                hydrogenAtom1.animate(
                  { left: 494, top: 448, opacity: 1 },
                  {
                    duration: 1000 * time,
                    onChange: canvasModel.renderAll.bind(canvasModel),
                    onComplete: function () {
                ...
                hydrogenAtom2.animate(
                  { left: 501, top: 448, opacity: 1 },
                  {
                    duration: 1000 * time,
                    onChange: canvasModel.renderAll.bind(canvasModel),
                    onComplete: function () {
...
function movePhoton2(hasH20) {
  ...
  photon2.animate(
    { left: 355, top: 433 },
    {
      ...
      onChange: canvasModel.renderAll.bind(canvasModel),
      onComplete: function () {
        chlorophyll2.animate(
          { left: 372, top: 425, angle: 56 },
          {
            duration: 100 * time,
            onChange: canvasModel.renderAll.bind(canvasModel),
            onComplete: function () {
              ...
              if (!hasH20) {
                ...
                hydrogenAtom3.animate(
                  { left: 508, top: 448, opacity: 1 },
                  {
                    duration: 1000 * time,
                    onChange: canvasModel.renderAll.bind(canvasModel),
                    onComplete: function () {
                ...
                hydrogenAtom4.animate(
                  { left: 515, top: 448, opacity: 1 },
                  {
                    duration: 1000 * time,
                    onChange: canvasModel.renderAll.bind(canvasModel),
                    onComplete: function () {
...
function hydroCascade() {
  ...
  atpDomino1.animate(
    { left: 522, top: 440, angle: 37 },
    {
      duration: 50 * time,
      onChange: canvasModel.renderAll.bind(canvasModel),
      onComplete: function () {
        atpDomino2.animate(
          { left: 565, top: 420, angle: 34 },
          {
            duration: 50 * time,
            onChange: canvasModel.renderAll.bind(canvasModel),
            onComplete: function () {
              energyCarrierEMPTY99.animate(
                { angle: 0 },
                {
                  duration: 50 * time,
                  onChange: canvasModel.renderAll.bind(canvasModel),
...
function energyMove(id, left, top) {
  ...
  energyCarrierFULL.animate(
    { left: left, top: top, angle: 0 },
    {
      duration: 700 * time,
      onChange: canvasModel.renderAll.bind(canvasModel),
    }
...
function formH20() {
  for (var i = 1; i <= waterCounter - 6; i++) {
    ...
    outputH2O.animate(
      { left: 560, top: 140 + i * 25, opacity: 1 },
      {
        duration: 1500 * time,
        onChange: canvasModel.renderAll.bind(canvasModel),
      }
...
function scatterSingleOxy(id) {
  ...
  singleOxy.animate(
    {
      left: Math.random() * (randomLeftMax - randomLeftMin + 1) + randomLeftMin,
      top: Math.random() * (randomTopMax - randomTopMin + 1) + randomTopMin,
      opacity: 1,
    },
    {
      duration: 1500 * time,
...
function neutralize() {
  for (var i = 1; i <= waterCounter - 6; i++) {
    ...
    if (i == 1 || i == 2) {
      singleOxy.animate(
        { left: 530 + i * 30, top: 248, opacity: 1 },
        {
          duration: 1500 * time,
          onChange: canvasModel.renderAll.bind(canvasModel),
        }
      ...
      singleOxy.animate(
        { left: 470 + i * 30, top: 268, opacity: 1 },
        {
          duration: 1500 * time,
          onChange: canvasModel.renderAll.bind(canvasModel),
        }
      ...
      singleOxy.animate(
        { left: 410 + i * 30, top: 288, opacity: 1 },
        {
          duration: 1500 * time,
          onChange: canvasModel.renderAll.bind(canvasModel),
        }
...
function collectCO2() {
  for (var i = 1; i <= 6; i++) {
    ...
    carbonDioxide.animate(
      { left: 579, top: 166 + i * 20, opacity: 0 },
      {
        duration: 2000 * time,
        onChange: canvasModel.renderAll.bind(canvasModel),
      }
...
function resetCascade() {
  $("#start, #resetAnimation, #lightOn, #co2Input, #h2oInput, #speedSwitch").prop(
    "disabled",
    false
  );
